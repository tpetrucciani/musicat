...
var author$project$Catalogue$optionalFieldWithDefault = F3(
	function (fieldName, fieldDecoder, _default) {
		return elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
					A2(elm$json$Json$Decode$field, fieldName, fieldDecoder),
					elm$json$Json$Decode$succeed(_default)
				]));
	});
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Catalogue$optionalStringFieldWithDefault = F2(
	function (fieldName, _default) {
		return A3(author$project$Catalogue$optionalFieldWithDefault, fieldName, elm$json$Json$Decode$string, _default);
	});
...
var author$project$Catalogue$simplifyString = A2(elm$core$Basics$composeR, elm$core$String$toLower, kuon$elm_string_normalize$String$Normalize$removeDiacritics);
var author$project$Catalogue$stringField = function (fieldName) {
	return A2(elm$json$Json$Decode$field, fieldName, elm$json$Json$Decode$string);
};
var elm$json$Json$Decode$andThen = _Json_andThen;
var elm$json$Json$Decode$map = _Json_map1;
var elm$json$Json$Decode$map2 = _Json_map2;
var author$project$Catalogue$groupingDecoder = function () {
	var actualGroupingDecoder = A2(
		elm$json$Json$Decode$andThen,
		function (g) {
			return A3(
				elm$json$Json$Decode$map2,
				author$project$Catalogue$Grouping,
				elm$json$Json$Decode$succeed(g),
				A2(
					elm$json$Json$Decode$map,
					author$project$Catalogue$simplifyString,
					A2(author$project$Catalogue$optionalStringFieldWithDefault, 'groupingSortKey', g)));
		},
		author$project$Catalogue$stringField('grouping'));
	return elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2(elm$json$Json$Decode$map, elm$core$Maybe$Just, actualGroupingDecoder),
...
var author$project$Catalogue$stringFieldWithLookupInDict = F2(
		...
		return A2(
			...
			function (id) {
				return A2(
					...
					elm$json$Json$Decode$fail('Identifier ' + (id + ' not found')),
					A2(
						elm$core$Maybe$map,
						elm$json$Json$Decode$succeed,
						A2(elm$core$Dict$get, id, dict)));
			},
			author$project$Catalogue$stringField(fieldName));
	});
var elm$json$Json$Decode$map3 = _Json_map3;
var author$project$Catalogue$entryDecoder = F2(
	function (genres, artists) {
		return A4(
			elm$json$Json$Decode$map3,
			author$project$Catalogue$Entry,
			A2(author$project$Catalogue$stringFieldWithLookupInDict, 'genre', genres),
			A2(author$project$Catalogue$stringFieldWithLookupInDict, 'artist', artists),
			author$project$Catalogue$groupingDecoder);
	});
...
var author$project$Catalogue$optionalField = F2(
	function (fieldName, fieldDecoder) {
		return elm$json$Json$Decode$maybe(
			A2(elm$json$Json$Decode$field, fieldName, fieldDecoder));
	});
var author$project$Catalogue$optionalStringField = function (fieldName) {
	return A2(author$project$Catalogue$optionalField, fieldName, elm$json$Json$Decode$string);
};
var elm$json$Json$Decode$bool = _Json_decodeBool;
var elm$json$Json$Decode$list = _Json_decodeList;
var elm$json$Json$Decode$map7 = _Json_map7;
var author$project$Catalogue$albumDecoder = F2(
	function (genres, artists) {
		return A8(
			elm$json$Json$Decode$map7,
			author$project$Catalogue$Album,
			author$project$Catalogue$stringField('cover'),
			A2(
				elm$json$Json$Decode$field,
				'entries',
				elm$json$Json$Decode$list(
					A2(author$project$Catalogue$entryDecoder, genres, artists))),
			author$project$Catalogue$optionalStringField('qobuz'),
			author$project$Catalogue$optionalStringField('spotify'),
			A3(author$project$Catalogue$optionalFieldWithDefault, 'local', elm$json$Json$Decode$bool, false),
			A3(author$project$Catalogue$optionalFieldWithDefault, 'archived', elm$json$Json$Decode$bool, false),
			author$project$Catalogue$optionalStringField('booklet'));
	});
...
var author$project$Catalogue$artistsDecoder = function () {
	...
	var artistInfoDecoder = A2(
		elm$json$Json$Decode$andThen,
		function (n) {
			return A4(
				elm$json$Json$Decode$map3,
				author$project$Catalogue$ArtistInfo,
				elm$json$Json$Decode$succeed(n),
				A2(author$project$Catalogue$optionalStringFieldWithDefault, 'shortName', n),
				A2(
					elm$json$Json$Decode$map,
					author$project$Catalogue$simplifyString,
					A2(author$project$Catalogue$optionalStringFieldWithDefault, 'sortKey', n)));
		},
		author$project$Catalogue$stringField('name'));
	return A2(
		elm$json$Json$Decode$map,
		elm$core$Dict$map(artistInfoToArtist),
...
var author$project$Catalogue$genresDecoder = function () {
	...
	var genreInfoDecoder = A2(
		elm$json$Json$Decode$andThen,
		function (n) {
			return A3(
				elm$json$Json$Decode$map2,
				author$project$Catalogue$GenreInfo,
				elm$json$Json$Decode$succeed(n),
				A2(
					elm$json$Json$Decode$map,
					author$project$Catalogue$simplifyString,
	...
	return A2(
		elm$json$Json$Decode$map,
		elm$core$Dict$map(genreInfoToGenre),
		elm$json$Json$Decode$dict(genreInfoDecoder));
}();
var elm$core$Tuple$pair = F2(
	function (a, b) {
		return _Utils_Tuple2(a, b);
	});
var author$project$Catalogue$pair = F2(
	function (da, db) {
		return A3(elm$json$Json$Decode$map2, elm$core$Tuple$pair, da, db);
	});
...
var author$project$Catalogue$catalogueDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (_n0) {
		var g = _n0.a;
		var a = _n0.b;
		return A5(
			...
			author$project$Catalogue$Catalogue,
			elm$json$Json$Decode$succeed(
				elm$core$Dict$values(g)),
			elm$json$Json$Decode$succeed(
			...
			A2(
				...
				'albums',
				elm$json$Json$Decode$list(
					A2(author$project$Catalogue$albumDecoder, g, a))),
			A2(
				elm$json$Json$Decode$field,
				'config',
				author$project$Catalogue$configDecoder(g)));
	},
	A2(
		author$project$Catalogue$pair,
		A2(elm$json$Json$Decode$field, 'genres', author$project$Catalogue$genresDecoder),
		A2(elm$json$Json$Decode$field, 'artists', author$project$Catalogue$artistsDecoder)));
var author$project$Main$GotCatalogue = function (a) {
	return {$: 0, a: a};
};
...
var author$project$Main$Local = 0;
var author$project$Main$Missing = 3;
var author$project$Main$OnlyUnarchived = 0;
var author$project$Main$Qobuz = 2;
var author$project$Main$Spotify = 1;
var author$project$Main$deduplicateSortedList = function (l) {
	...
	while (true) {
		if (l.b && l.b.b) {
			...
			if (_Utils_eq(x, y)) {
				var $temp$l = ll;
				l = $temp$l;
				continue deduplicateSortedList;
			} else {
				return A2(
					elm$core$List$cons,
					x,
					author$project$Main$deduplicateSortedList(ll));
			}
		} else {
			return l;
		}
...
var author$project$Main$initAssocList = function (f) {
...
var author$project$Main$makeState = function (catalogue) {
	...
	var albumsForGenreAndArtist = F2(
		function (genre, artist) {
			...
			var albumsForGrouping = function (grouping) {
				return A2(
					elm$core$List$filter,
					matchesGrouping(grouping),
					albums);
			};
			var groupings = author$project$Main$deduplicateSortedList(
				A2(
					elm$core$List$sortBy,
					function ($) {
						return $.n;
					...
					A2(
						...
						albums)));
			return _Utils_Tuple2(
				albumsForGrouping(elm$core$Maybe$Nothing),
				A2(
					elm$core$List$map,
					function (g) {
						return _Utils_Tuple2(
	...
	var albumsByArtistForGenre = function (genre) {
		return A2(
			author$project$Main$initAssocList,
			albumsForGenreAndArtist(genre),
			artists);
	};
	var albumsByGenreAndArtist = elm$core$Dict$fromList(
		A2(
			author$project$Main$initAssocList,
			albumsByArtistForGenre,
			A2(
				elm$core$List$map,
				function ($) {
					return $.W;
		...
		switch (model.$) {
			case 0:
				if (!msg.$) {
					var result = msg.a;
					if (!result.$) {
						var catalogue = result.a;
						return _Utils_Tuple2(
							author$project$Main$Success(
								author$project$Main$makeState(catalogue)),
...
var author$project$Main$Both = 2;
var author$project$Main$ChangeArchiveVisibility = function (a) {
	return {$: 2, a: a};
};
var author$project$Main$OnlyArchived = 1;
...
var author$project$Main$box = F4(
	function (type_, msg, name, isChecked) {
		return A2(
			elm$html$Html$label,
			_List_Nil,
			_List_fromArray(
...
var author$project$Main$putIcons = function (album) {
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Attributes$class('icon-spotify')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$title('Show in Spotify'),
			...
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('icon'),
							elm$html$Html$Attributes$class('icon-qobuz')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$title('Show in Qobuz'),
									elm$html$Html$Attributes$href('qobuzapp://album/' + id)
								]),
							_List_fromArray(
								[
									elm$html$Html$text('Qobuz')
								]))
						]))
				]);
		} else {
	...
	var localIcon = album.a0 ? _List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('icon'),
					elm$html$Html$Attributes$class('icon-local')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$title('The album is available locally')
						]),
					_List_fromArray(
						[
			...
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('icon'),
							elm$html$Html$Attributes$class('icon-booklet')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$title('Show album booklet'),
									elm$html$Html$Attributes$href('data/booklets/' + path)
								]),
							_List_fromArray(
								[
	...
	var archivedIcon = album.aH ? _List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('icon'),
					elm$html$Html$Attributes$class('icon-archived')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$title('The album is archived')
						]),
					_List_fromArray(
						[
	...
	return elm$core$List$concat(
		_List_fromArray(
			[localIcon, qobuzIcon, spotifyIcon, bookletIcon, archivedIcon]));
};
...
var kuon$elm_string_normalize$String$Normalize$cleanup = F3(
	function (keepChars, separator, str) {
		...
		var replace = F2(
			function (c, _n3) {
				var resultAcc = _n3.a;
				var isPreviousBoundary = _n3.b;
				var isPreviousKeep = _n3.c;
				var _n1 = A2(elm$core$Dict$get, c, kuon$elm_string_normalize$String$Normalize$Diacritics$lookupTable);
				if (!_n1.$) {
					var candidate = _n1.a;
					...
					var _n2 = removePunctuation(c);
					var replacement = _n2.a;
					var isBoundary = _n2.b;
					var isKeep = _n2.c;
...
var kuon$elm_string_normalize$String$Normalize$url = function (str) {
	return A3(
		kuon$elm_string_normalize$String$Normalize$cleanup,
...
var author$project$Main$displayGrouping = F3(
	function (starredAlbums, artist, _n0) {
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('grouping')
				]),
			A2(
				elm$core$List$cons,
				A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('grouping-name')
						]),
					_List_fromArray(
						[
							A2(
	...
	function (state, _n0) {
		...
		var contents = _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('grouping-links')
					]),
				A2(
					elm$core$List$map,
					A2(elm$core$Basics$composeL, author$project$Main$displayGroupingLink, elm$core$Tuple$first),
					albumsByGrp)),
				A2(
				elm$html$Html$div,
				_List_fromArray(
...
var author$project$Main$displayArtistList = function (albumsByArtist) {
	var makeName = function (artist) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('artist-list-name')
				]),
			_List_fromArray(
				[
					A2(
	...
	var makeLetter = function (letter) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('artist-list-letter')
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
					elm$core$String$toUpper(letter))
				]));
	};
	var firstLetter = function (artist) {
		return A2(elm$core$String$left, 1, artist.n);
	};
	var artists = A2(elm$core$List$map, elm$core$Tuple$first, albumsByArtist);
	var artistsAndLetters = elm$core$List$reverse(
		A3(
			elm$core$List$foldl,
			F2(
				function (artist, _n1) {
	...
	var artistLinks = A2(
		...
		function (_n0) {
			var artist = _n0.a;
			var showLetter = _n0.b;
			return showLetter ? A2(
				elm$html$Html$span,
				_List_Nil,
				_List_fromArray(
					[
...
var author$project$Main$SetGenre = function (a) {
	return {$: 0, a: a};
};
...
var author$project$Main$ToggleSourceVisibility = function (a) {
	return {$: 3, a: a};
};
var author$project$Main$checkbox = author$project$Main$box('checkbox');
var author$project$Main$sourceName = function (source) {
	switch (source) {
		case 0:
			return 'Local';
		case 1:
...
var author$project$Main$displaySourceVisibilitySelector = function (state) {
	var source2checkbox = function (s) {
		return A3(
...
var author$project$Main$isJust = function (x) {
	if (!x.$) {
		return true;
	} else {
		return false;
...
var author$project$Main$matchesSourceVisibility = F2(
	...
	function (filter, artist) {
		...
		return A2(
			...
			function (w) {
				return A2(
					elm$core$List$any,
					elm$core$String$startsWith(w),
					nameWords);
			},
			elm$core$String$words(filter));
	});
...
var author$project$Main$getVisibleAlbumsByArtist = function (state) {
	...
	return A2(
		...
		function (_n3) {
			var _n4 = _n3.b;
			var albumsNoGrp = _n4.a;
			var albumsByGrp = _n4.b;
			return (!elm$core$List$isEmpty(albumsNoGrp)) || A2(
				elm$core$List$any,
				A2(
					elm$core$Basics$composeL,
...
var author$project$Main$viewBody = function (model) {
	switch (model.$) {
		...
		default:
			var state = model.a;
			var visibleAlbumsByArtist = author$project$Main$getVisibleAlbumsByArtist(state);
			return _List_fromArray(
				[
					A2(
					elm$html$Html$div,
					...
					_List_fromArray(
						[
							elm$html$Html$text('Colours based on the Atom One themes. ' + 'Font: Source Sans Pro.')
						]))
				]);
	}
};
